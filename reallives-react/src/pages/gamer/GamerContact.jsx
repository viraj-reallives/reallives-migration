...
import styles from './GamerContact.module.css';

export default function GamerContact() {
  ...
  return (
    <div className={styles.page} id="contact-us">
      <div className={styles.pageHeader}>
        {contact.heading ? <h1 className={styles.heading}>{contact.heading}</h1> : null}
      </div>
        ...
        <div className={styles.formSection}>
          <form className={styles.form} onSubmit={handleSubmit} noValidate>
            <div className={styles.field}>
              <label htmlFor="gamer-contact-name" className={styles.label}>
                {labels.name}
              </label>
              <input
                id="gamer-contact-name"
                name="name"
                type="text"
                autoComplete="name"
            ...
            <div className={styles.field}>
              <label htmlFor="gamer-contact-email" className={styles.label}>
                {labels.email}
              </label>
              <input
                id="gamer-contact-email"
                name="email"
                type="email"
                autoComplete="email"
                className={styles.input}
            ...
            <div className={styles.field}>
              <label htmlFor="gamer-contact-message" className={styles.label}>
                {labels.message}
              </label>
              <textarea
                id="gamer-contact-message"
                name="message"
                rows={5}
