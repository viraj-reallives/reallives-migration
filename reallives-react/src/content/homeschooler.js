...
export const homeschoolerContent = {
  ...
  products: {
    ...
    cards: [
      {
        ...
        imagePath: '/assets/images/homeschooler/logo-image/real-r-logo.svg',
      ...
      },
      {
        ...
        imagePath: '/assets/images/homeschooler/logo-image/empathy-logo.svg',
      ...
      },
      {
        ...
        imagePath: '/assets/images/homeschooler/logo-image/realboard-logo.svg',
      ...
      },
      {
        ...
        imagePath: '/assets/images/homeschooler/logo-image/changemaker-logo.svg',
    ...
    realAiTab: {
      ...
      logoPath: '/assets/images/homeschooler/image/real-r-logo.svg',
      gridImages: [
  ...
  changemaker: {
    ...
    phases: [
      {
        ...
        imagePath: '/assets/images/homeschooler/image/change-maker-1-img.svg',
      },
      {
        ...
        imagePath: '/assets/images/homeschooler/image/change-maker-2-img.svg',
      },
      {
        ...
        images: [
          '/assets/images/homeschooler/image/chnage-maker-3-img.svg',
          '/assets/images/homeschooler/image/change-maker-4-img.svg',
        ],
      },
    ],
    ...
    heroBackgroundImagePath: '/assets/images/homeschooler/image/Chnage-maker-univercity-background.svg',
  ...
  impact: {
    ...
    worldMapImagePath: '/assets/images/homeschooler/image/world-map.svg',
    ...
    sliderImages: [
      '/assets/images/homeschooler/image/Final Business with Purpose 1.png',
      '/assets/images/homeschooler/image/school-1-image-slider.png',
      '/assets/images/homeschooler/image/school-2-image-slider.png',
      '/assets/images/homeschooler/image/school-3-image-slider.png',
      '/assets/images/homeschooler/image/school-4-image-slider.png',
      '/assets/images/homeschooler/image/second-workshop-2.png',
      '/assets/images/homeschooler/image/second-workshop-3.png',
      '/assets/images/homeschooler/image/second-workshop-4.png',
      '/assets/images/homeschooler/image/3-rd-workshop-first-image.jpeg',
      '/assets/images/homeschooler/image/3-rd-workshop-2.png',
      '/assets/images/homeschooler/image/3-rd-workshop-3.png',
      '/assets/images/homeschooler/image/3-rd-workshop-4.png',
    ],
    cards: [
      {
        title: 'ETH Zurich Workshop',
        date: '27/06/2018',
        imagePath: '/assets/images/homeschooler/image/Final Business with Purpose 1.png',
      ...
      },
      {
        ...
        date: '20/09/2025',
        imagePath: '/assets/images/homeschooler/image/second-workshop.png',
      ...
      },
      {
        ...
        date: '29/09/2025',
        imagePath: '/assets/images/homeschooler/image/3-rd-workshop-first-image.jpeg',
      ...
      },
      {
        ...
        date: '07/11/2024',
        imagePath: '/assets/images/homeschooler/image/fourth_workshop-1-min.jpg',
  ...
  research: {
    ...
    heroImagePath: '/assets/images/homeschooler/image/Korea Univercity img.svg',
    browseIntro:
    ...
    items: [
      {
        ...
        logoPath: '/assets/images/homeschooler/image/Korea-university.svg',
      },
      {
        ...
        logoPath: '/assets/images/homeschooler/image/uwe-bristol-img.svg',
      },
      {
        ...
        whatWasStudied:
          'How probabilistic life modeling influences learning, empathy, and understanding of global inequality.',
        logoPath: '/assets/images/homeschooler/image/Santa-clara-university.svg',
      ...
      },
      {
        ...
        whatWasStudied:
          'How probabilistic life modeling influences learning, empathy, and understanding of global inequality.',
        logoPath: '/assets/images/homeschooler/image/University-Albany.svg',
      },
      {
        ...
        logoPath: '/assets/images/homeschooler/image/Uppsala_University_logo.svg 2.svg',
  ...
  about: {
      ...
      milestones: [
        {
          ...
          images: [
            '/assets/images/homeschooler/image-add/reallives-light-1.svg',
            '/assets/images/homeschooler/image-add/reallives-light-2.svg',
            '/assets/images/homeschooler/image-add/reallives-light-3.svg',
            '/assets/images/homeschooler/image/rl-logo-light.svg',
            '/assets/images/homeschooler/image/rl-logo-light-ai.svg',
          ],
        },
        {
    ...
    team: {
      leader: {
        ...
        imagePath: '/assets/images/homeschooler/image-add/ceo-image.jpg',
        bioParagraphs: [
      ...
      academicResearchCoordinator: {
        ...
        imagePath: '/assets/images/homeschooler/image/YDD-2.png',
        bioParagraphs: [
    ...
    globalSupport: {
      ...
      specialThanks: [
        {
          imagePath: '/assets/images/homeschooler/global-support-image/thanks-ashoka-img.jpg',
          body:
        ...
        {
          imagePath: '/assets/images/homeschooler/global-support-image/bmgi-img.jpg',
          body:
        ...
        {
          imagePath: '/assets/images/homeschooler/global-support-image/impact-world-img.png',
          body:
      ...
      alwaysGratefulMembers: [
        {
          ...
          imagePath: '/assets/images/homeschooler/global-support-image/Lee Hartwell-img.jpg',
        },
        {
          name: 'David Gibson',
          ...
          imagePath: '/assets/images/homeschooler/global-support-image/David Gibson-img.jpg',
        },
        {
          ...
          imagePath: '/assets/images/homeschooler/global-support-image/Laura Giadorou-Koch-img.jpg',
        },
        {
          name: 'Naresh Shahani',
          ...
          imagePath: '/assets/images/homeschooler/global-support-image/Naresh Shahani-img.jpg',
        },
        {
          name: 'Abhay Nalawade',
          location: 'Pune, India',
          ...
          imagePath: '/assets/images/homeschooler/global-support-image/Abhay Nalawade-img.jpg',
        },
        {
          name: 'Milind Desai',
          location: 'Mumbai, India',
          description: 'Advisor, Trackball Consultancy Services Private Limited',
          imagePath: '/assets/images/homeschooler/global-support-image/Milind Desai-img.jpg',
        },
      ],
    ...
    inventor: {
      ...
      imagePath: '/assets/images/homeschooler/image-add/bob-image.jpg',
      bioParagraphs: [
  ...
  footer: {
    ...
    logo: '/assets/images/homeschooler/logo-image/real-r-logo.svg',
    logoPath: '/assets/images/homeschooler/logo-image/real-r-logo.svg',
    socialLinks: [
      {
        platform: 'YouTube',
