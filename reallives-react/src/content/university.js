...
import {
  empathyCanvasTabShared,
  realBoardTabShared,
} from "./productsEmpathyRealBoardShared";
...
export const universityContent = {
  ...
  hero: {
    heading: "RealLives Academic for Higher Education",
    subheading:
      ...
      whySchoolsBullets: [
        {
          ...
          body: "RealLives supports courses across sociology, anthropology, political science, economics, international relations, public policy, and development studies. Faculty can customize simulations to align with specific research interests and theoretical frameworks.",
        },
        {
          title: "Research-Quality Data Integration\u00a0",
          body: "Built on comprehensive demographic, economic, and social datasets from 200+ countries, RealLives provides students with authentic exposure to global inequality, policy impacts, and structural constraints that shape life outcomes worldwide.",
        },
        {
          title: "Flexible Pedagogical Framework",
          body: "Adaptable to various teaching methodologies from flipped classrooms to seminar discussions, independent research projects to collaborative policy analysis.",
        },
      ],
      howItWorksHeading: "Course Integration Examples",
      howItWorksSubheading: "Graduate Level Applications",
      howItWorksParagraphs: [
        {
          label: "Introduction to Sociology:",
          body: "Exploring social stratification and mobility across different national contexts",
        },
        {
          label: "Development Economics:",
          body: "Examining poverty, education access, and economic opportunity structures",
        },
        {
          label: "Global Studies:",
          body: "Understanding cultural adaptation and transnational migration patterns",
        },
      ],
      educationalBenefitsHeading: "Academic Benefits",
      educationalBenefits: [
        {
          title: "Critical Thinking :\u00a0",
          body: "Students learn to see how choices and circumstances affect life outcomes, and think about cause and effect in society.",
        },
        {
          title: "Exploring Data :\u00a0\u00a0",
          body: "Real-world statistics in the game help students notice patterns and compare life experiences across countries.",
        },
        {
          title: "Global AwarenessBy :\u00a0",
          body: "living virtual lives in different cultures, students build empathy and a better understanding of the world.",
        },
      ],
  ...
  products: {
    ...
    cards: [
      ...
      },
      {
        ...
        imagePath:
          "https://d2jn82ki4w4ftn.cloudfront.net/reallives-website/logos/empathy-logo.svg",
      ...
      },
      {
        ...
        imagePath:
          "https://d2jn82ki4w4ftn.cloudfront.net/reallives-website/logos/realboard-logo.svg",
      ...
      },
      {
        ...
        imagePath:
          "https://d2jn82ki4w4ftn.cloudfront.net/reallives-website/logos/changemaker-logo.svg",
  ...
  impact: {
    ...
    worldMapImagePath:
      "https://d2jn82ki4w4ftn.cloudfront.net/reallives-website/common-impact-page/world-map.svg",
    ...
    cards: [
      {
        ...
        learnMorePath: "/reallives/university/ETH-Zurich-Workshop",
      },
      {
        title: "Navamindradhiraj University Workshop",
        date: "20/09/2025",
        imagePath:
          "https://d2jn82ki4w4ftn.cloudfront.net/reallives-website/common-impact-page/second-workshop.png",
        ...
        learnMoreText: "Learn more",
        learnMorePath: "/reallives/university/Navamindradhiraj-University-Workshop",
      },
      {
        ...
        learnMoreText: "Learn more",
        learnMorePath: "/reallives/university/Kyung-Hee-University-Workshop",
      },
      {
        title: "IIT Bombay Exploring SDG 1 through Empathy Workshop",
        date: "07/11/2024",
        imagePath:
          "https://d2jn82ki4w4ftn.cloudfront.net/reallives-website/common-impact-page/fourth_workshop-1-min.jpg",
        ...
        learnMoreText: "Learn more",
        learnMorePath: "/reallives/university/IIT-Bombay-Workshop",
      },
      {
        title: "Chulalongkorn University Workshop",
        date: "27/04/2024",
        imagePath:
          "https://d2jn82ki4w4ftn.cloudfront.net/reallives-website/common-impact-page/fifth-work-shop-1.png",
        ...
        learnMoreText: "Learn more",
        learnMorePath: "/reallives/university/Chulalongkorn-University-Workshop",
      },
    ],
  },
  ...
  research: {
    ...
    body: "RealLives Simulation has been independently studied by universities and educators worldwide.Peer-reviewed research demonstrates its impact on empathy, global citizenship, identity development, decision-making, and SDG-aligned learning outcomes across age groups.",
    heroImagePath:
    ...
    items: [
      {
        ...
        detail: {
          ...
          route: "/reallives/university/Korea-University-Research",
        },
      },

      {
        ...
        detail: {
          ...
          route: "/reallives/university/UWE-Bristol-Research",
        },
      },

      {
        ...
        detail: {
          heroImagePath:
            "https://d2jn82ki4w4ftn.cloudfront.net/reallives-website/common-research-page/Santa-university-png.png",
          heroTitle:
            "Simulating REAL LIVES: Promoting Global Empathy and Interest in Learning Through Simulation Games",
          heroSubtitle:
            "How role-playing simulated lives from different countries affects students’ affective and motivational learning outcomes.",
          ...
          route: "/reallives/university/Santa-Clara-University-Research",
        },
      },

      {
        ...
        detail: {
          ...
          route: "/reallives/university/SUNY-Albany-Research",
        },
      },

      {
        ...
        detail: {
          ...
          route: "/reallives/university/Uppsala-University-Research",
        },
      },

      {
        ...
        detail: {
          ...
          route: "/reallives/university/Kallen-Tsikalas-Youth-Simulation-Research",
        },
      },

      {
        ...
        detail: {
          ...
          route: "/reallives/university/KAME-Seoul-Multicultural-Research",
        },
      },
    ],
      ...
      specialThanks: [
        {
          ...
          body: "We thank Ashoka for fostering empathy and social innovation worldwide. Their recognition of Dr. Parag Mankeeker as an Ashoka Fellow validated our mission and connected us with a global network of changemakers who share our vision of building cross-cultural understanding through transformative education.",
        },
        {
          imagePath:
            "https://d2jn82ki4w4ftn.cloudfront.net/reallives-website/common-about-us-page/bmgi-img.jpg",
          body: "We thank BMGI Global for their strategic partnership and management consulting expertise across India and the Asia Pacific region. Their professional guidance has helped us navigate complex markets while staying true to our mission of creating meaningful educational impact through technology.",
        },
        {
          imagePath:
            "https://d2jn82ki4w4ftn.cloudfront.net/reallives-website/common-about-us-page/impact-world-img.png",
          body: "We are grateful to Ashoka Globalizer for accelerating our worldwide impact. Their specialized support in scaling social innovations has been instrumental in helping RealLives reach new communities globally, amplifying our ability to foster empathy and understanding in classrooms around the world.",
        },
      ],
    ...
    columns: [
      {
        ...
        links: [
          {
            label: "RealLives Simulation",
            path: "/reallives/university/products",
          },
          { label: "Empathy Canvas", path: "/reallives/university/products" },
          { label: "RealBoard", path: "/reallives/university/products" },
          {
            label: "ChangeMaker Index",
            path: "/reallives/university/products",
          },
          { label: "Pricing", path: "/reallives/university/pricing" },
        ],
        ...
        links: [
          {
            ...
            path: "/reallives/university/changemaker",
          },
          { label: "Resources", path: "/reallives/university" },
          {
            label: "Research & Evidence",
            path: "/reallives/university/research",
          },
        ],
      },
      {
